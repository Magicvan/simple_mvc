            ...
            <div class="container">
              ...
              <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right scrollto">
                  ...
                  <li class="active"><a href="<?php echo $helper->url("Tags", "index"); ?>">Tags</a></li>
      ...
      <section id="tags">
        <div class="container">
          ...
          <ul class="listado-tags"> 
            <li class="row first"><div class="col-xs-12 col-sm-4">TAG</div><div class="col-xs-12 col-sm-4">UPDATE</div><div class="col-xs-12 col-sm-4">DELETE</div></li>         
            <?php foreach ($tags as $key => $value){ ?>
            <li class="row">
              <div class="col-xs-12 col-sm-4"><?php print $value->TAG;?></div>
              <div class="col-xs-12 col-sm-4"><a href="<?php echo $helper->url("Tags", "edit"); ?>&id=<?php print $value->ID;?>">Edit</a></div>
              <div class="col-xs-12 col-sm-4"><a href="<?php echo $helper->url("Tags", "delete");?>&id=<?php print $value->ID;?>" data-toggle="confirmation">Delete</a></div>
            </li>
            <?php } ?>
          </ul>
          <?php 
          }else{ ?>
            <p>No hay tags creadas.</p>            
          <?php 
          }?>
          <div class="btn-group btn-group-lg">
            <span class="btn new-tag">Crear nueva tag</span>
          </div>
          <div id="newTag" class="hidden">
            <form action="<?php echo $helper->url("Tags", "create"); ?>" method="post">
              <input class="col-xs-12 col-sm-12" type="text" placeholder="Tag" name="tag"/>
