            ...
            <div class="container">
              ...
              <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right scrollto">
                  ...
                  <li><a href="<?php echo $helper->url("Home", "index"); ?>">Tags</a></li>
        ...
        <div class="container">
          ...
          if (!empty($entradas)){ ?>
            ...
            <?php if (!empty($reltags)){ ?>
              <div class="tags">
                <ul><span>TAGS</span>
              <?php foreach ($reltags as $key => $value) { ?>
                <li><?php print $value->tag;?></li>
              <?php } ?>
                </ul>
              </div>
            <?php } ?>
            <?php foreach ($entradas as $key => $value){ ?>
              <form action="<?php echo $helper->url("Entradas", "update"); ?>" method="post">
                <input class="col-xs-12 col-sm-5" type="text" placeholder="Name" name="name" value="<?php print $value->NAME; ?>"/>
                <input class="col-xs-12 col-sm-5" type="text" placeholder="Description" name="description"  value="<?php print $value->DESCRIPTION; ?>"/>
